...
class T23DQA(Dataset):
    def __init__(self, infos, data_dir, transforms=None, shuffle=False):
        ...
        # chinese_data_info = pd.read_excel("/home/lhh/codes/AIG3DCQA/MVAG3D/data/mate3d/prompts_MATE_3D.xlsx").to_dict("records")
    ...
    def __getitem__(self, index):
        ...
        mid = info["id"]
        geo_mos = info["geo_quality"]
        texture_mos = info["texture_quality"]
        align_mos = info["align_quality"]
        overall_mos = (geo_mos + texture_mos + align_mos) / 3
        ...
        for i in range(self.num_views):
            ...
            # imge_name = os.path.join(self.data_dir, f"{name_model}_{name_prompt}_{i*2}.png")
